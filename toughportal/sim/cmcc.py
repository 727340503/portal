...
from toughportal.packet import pktutils
import datetime
import binascii
import logging
import socket
...
class PortalSim(protocol.DatagramProtocol):
    ...
    def doAckLogout(self,req):
        ...
        resp2 = cmcc.PortalV2.newMessage(
    ...
    def datagramReceived(self, datagram, (host, port)):
        try:
            ...
            print cmcc.hexdump(datagram,len(datagram))
            _packet = cmcc.PortalV2(secret=self.secret,packet=datagram,source=(host, port))
            ...
            print
            if resp:
                print cmcc.hexdump(str(resp),len(resp))
